...
#define TZDEV_DRIVER_CODE		TZDEV_DRIVER_VERSION(2,0,1)
...
#define tzdev_smc_get_event()				tzdev_smc_cmd(TZDEV_SMC_GET_EVENT, 0x0ul, 0x0ul, 0x0ul)
...
#define tzdev_smc_update_ree_time(tv_sec, tv_nsec)	tzdev_smc_cmd(TZDEV_SMC_UPDATE_REE_TIME, (tv_sec), (tv_nsec), 0x0ul)
