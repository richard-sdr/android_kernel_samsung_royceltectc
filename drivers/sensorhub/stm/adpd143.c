...
static int __arr_mode_IDLE[MAX_IDLE_MODE] =
				{ IDLE_OFF };
static int __arr_mode_SAMPLE[MAX_SAMPLE_MODE] =
				{ SAMPLE_XY_A, SAMPLE_XY_AB, SAMPLE_XY_B };
static int __arr_mode_TIA_ADC_SAMPLE[MAX_SAMPLE_MODE] =
				{ SAMPLE_XY_A, SAMPLE_XY_AB, SAMPLE_XY_B };

static struct mode_mapping __mode_recv_frm_usr[MAX_MODE] = {
	{
		.name = "IDLE",
		.mode_code = MODE(IDLE),
		.size = MODE_SIZE(IDLE)
