...
/* Command ID for smc */
#if defined(CONFIG_BLOWFISH)
#define SMC_PROTECTION_SET	0x82002010
#define SMC_DRM_FW_LOADING	0x82002011
#define SMC_DCPP_SUPPORT	0x82002015
#define SMC_DRM_MAKE_PGTABLE	0x82002016
#define SMC_DRM_CLEAR_PGTABLE	0x82002017
#define SMC_MEM_PROT_SET	0x82002018
#define SMC_DRM_SECMEM_INFO	0x82002019
#define SMC_DRM_VIDEO_PROC	0x8200201A
#define SMC_DRM_SECMEM_REGION_INFO	0x82002012
#define SMC_DRM_SECMEM_REGION_PROT	0x82002013
#define MC_FC_SET_CFW_PROT	0x82002014
#else
